    ...
    public class BaseTree
    {
        ...
        public BaseTree(string itemcode, int ClassId, string strNew)
        {
            try
            {
                ...
                if (ClassId == 1)
                {
                    var listObject = dal.GetBaseLayerObjectList(" ", " order by LayerObjectID", username);
                ...
                {
                    var listObject = dal.GetBaseFuncLayerObjectList(" ", " order by LayerObjectID", username);
        ...
        private bool IsAreaItemCode(string itemcode, string areaId, int classid)
        {
            ...
            try
            {
                ...
                int countValue = Framework.Common.BaseWcf.CreateChannel<ServiceInterface.IComplexReportService>("CoplexService").
