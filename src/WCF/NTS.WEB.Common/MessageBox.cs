...
namespace NTS.WEB.Common
{
	...
	{		
        ...
        public static void Error(System.Web.UI.Page page, string msg)
        {
            page.ClientScript.RegisterStartupScript(page.GetType(), "message","$tiansu.common.info('show', {timeout: 1000,content: '" + msg.ToString() +"'});") ;
        }
