...
(function ($, undefined) {
    ...
    function GetMon(m) {
        ...
        else if (3 <= m && m <= 5)   //第二季度
        {

            return 3;
        }
        else if (6 <= m && m <= 8)   //第三季度
        {
            return 6;
        }
        else if (9 <= m && m <= 11)  //第四季度
        {
            return 9;
        }
            ...
            case 'a':
                switch (target[0].className) {
                    ...
                    case 'latestWeek':
                        ...
                        var sDate = UTCDate(date.getFullYear(), date.getMonth(), date.getDate() - GetWeekDay(date.getDay()), 0, 0, 0),
									eDate = date;
                        var startDate = DPGlobal.formatDate(sDate, this.o.format, this.o.language),
									endDate = DPGlobal.formatDate(eDate, this.o.format, this.o.language);
                        if (typeof this.o.rangeDate === "function") {
                    ...
                    case 'latestMonth':
                        var date = this.o.serverDate ? new Date(this.o.serverDate) : new Date();
                        var sDate = UTCDate(date.getFullYear(), date.getMonth(), 1, 0, 0, 0),
									eDate = date;
                    ...
                    case 'latestQuarter':
                        var date = this.o.serverDate ? new Date(this.o.serverDate) : new Date();
                        var sDate = UTCDate(date.getFullYear(), GetMon(date.getMonth()), 1, 0, 0, 0),
									eDate = date;
                        //								if (sDate.getDate() < eDate.getDate()) {
