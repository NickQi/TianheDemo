...
loadPage.prototype = {
    ...
    */
    getAction: function () {
        return {
            GetDevicePropInfo: "action.ashx?action=GetDevicePayTypeInfo",
            SaveDeviceProp: "action.ashx?action=SaveDevicePayType"
        };
    }
};
...
$(function () {
    ...
    $("#btnSave").click(function () {
        var currentpaytypeid = $("#itemSave").val();
        var arr = new Array();
        ...
        if (currentpaytypeid == 0 || currentpaytypeid == "") {
            alert("请选择能源类型！");
            return;
        }
        else {
